...
* [CiteMe](https://citeme.app) is a free academic citation generator with a built-in reference checker that flags fabricated or hallucinated references. It searches 11+ databases (OpenAlex, PubMed, Semantic Scholar, CrossRef) and formats references in 40+ citation styles (APA, ABNT, MLA, Chicago). No sign-up; available in English, Spanish, Portuguese, French, and German.

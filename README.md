...
* [Peptide Calculations](https://github.com/PeptidoMexico/peptidomexico-open-science) Unit-aware, dependency-free tools for peptide reconstitution, concentration, dilution and molarity calculations, with a browser calculator and reproducible Python and R implementations. ([web calculator](https://peptidomexico.com.mx/calculadora/) | [documentation](https://peptidomexico-open-science.readthedocs.io/en/latest/))

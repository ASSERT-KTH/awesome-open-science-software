...
* [Lune Research](https://github.com/RetrogradeLabs/lune-mcp-server) Remote MCP server grounding coding agents in full-text peer-reviewed papers from top venues (NeurIPS, ICLR, ACL, CVPR, USENIX Security), with citation trails in both directions and claim verification that returns the verbatim supporting quote. Streamable HTTP + stdio. (`npx @retrograde-labs/lune-mcp-server`)
...
* [Peptide Calculations](https://github.com/PeptidoMexico/peptidomexico-open-science) Tools for peptide reconstitution, concentration, dilution and molarity calculations, with a browser calculator and reproducible Python and R implementations. ([web calculator](https://peptidomexico.com.mx/calculadora/) | [documentation](https://peptidomexico-open-science.readthedocs.io/en/latest/))
* [UnitConv](https://unitconv.online/) is a free browser-based unit converter for reproducible engineering and scientific calculations, backed by open conversion test vectors and rounding-validation tools. ([QA dataset](https://github.com/lyakhovpro-pixel/unit-conversion-qa-dataset) | [rounding lab](https://github.com/lyakhovpro-pixel/conversion-rounding-lab))
